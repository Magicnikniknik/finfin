export const DEMO_SCENARIOS = [
  {
    ...
    quote: {
      ...
      give_currency_id: '90000000-0000-0000-0000-000000000002',
      get_currency_id: '90000000-0000-0000-0000-000000000001',
      input_mode: 'GET',
      amount: '100.00',
    },
    reserve: {
  ...
  },
  {
    ...
    quote: {
      office_id: '22222222-2222-2222-2222-222222222222',
      give_currency_id: '90000000-0000-0000-0000-000000000001',
      get_currency_id: '90000000-0000-0000-0000-000000000002',
      input_mode: 'GET',
      amount: '10000.00',
    },
    reserve: {
  ...
  },
  {
    ...
    quote: {
      office_id: '22222222-2222-2222-2222-222222222222',
      give_currency_id: '90000000-0000-0000-0000-000000000004',
      get_currency_id: '90000000-0000-0000-0000-000000000002',
      input_mode: 'GIVE',
      amount: '0.10',
    },
  ...
  },
  {
    ...
    reserve: {
      quote_id: 'q_demo_expired_usdt_thb',
      side: 'SELL',
      give_amount: '100.00',
      get_amount: '3505.00',
      give_currency_id: '90000000-0000-0000-0000-000000000001',
